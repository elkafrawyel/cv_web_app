                      ...
                      builder: (context, constraints) {
                        ...
                        return Wrap(
                          ...
                          children: List.generate(skillCategories.length, (
                            ...
                            final category = skillCategories.keys.elementAt(
                              index,
                            );
...
class _SkillCategoryCardState extends State<_SkillCategoryCard>
                        ...
                        children: widget.skills.asMap().entries.map((entry) {
                          ...
                          return Padding(
                            padding: EdgeInsets.only(
                              bottom: index == widget.skills.length - 1
                                  ? 0
                                  : 8, // Reduced spacing
                            ),
                            child: _buildCompactSkillWithLevel(skill, index),
                          );
                        }).toList(),
                      ),
                    ],
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: isHovered
                  ? [widget.colors[0], widget.colors[1], widget.accentColor]
                  : widget.colors,
            ),
  ...
  Widget _buildCompactSkillWithLevel(String skill, int index) {
    return TweenAnimationBuilder<double>(
      duration: Duration(milliseconds: 600 + (index * 80)),
      tween: Tween(begin: 0.0, end: 1.0),
      builder: (context, animation, child) {
        return Transform.translate(
          offset: Offset((1 - animation) * 20, 0),
          child: Opacity(
            opacity: animation.clamp(0.0, 1.0),
            child: Container(
